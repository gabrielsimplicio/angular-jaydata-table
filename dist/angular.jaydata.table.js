(function() {
    ...
    angular.module("angular-jaydata-table", ['jaydata']);    
})();
(function() {
    'use strict';
        
    jayTableDirective.$inject = ["$filter", "$templateRequest", "$compile"];
...
(function() {
    ...
    jayTableBodyDirective.$inject = ["$compile", "$parse"];
    var app = angular.module("angular-jaydata-table");
...
(function() {
    ...
    jayTableHeadDirective.$inject = ["$compile"];
    var app = angular.module("angular-jaydata-table");
...
(function() {
    ...
    jayTablePaginationDirective.$inject = ["$rootScope"];
    var app = angular.module("angular-jaydata-table");
