...
datajsPatch=function(a){if(a&&a.jsonHandler&&"useJsonLight"in a.jsonHandler&&"object"===typeof datajs&&!datajs.version){$data.Trace.log("!!!!!!! - patch datajs 1.1.0");var b=a.defaultHandler.read;a.defaultHandler.read=function(a,c){delete c.contentType;delete c.dataServiceVersion;b.apply(this,arguments)};var c=a.defaultHandler.write;a.defaultHandler.write=function(a,b){delete b.contentType;delete b.dataServiceVersion;c.apply(this,arguments)}}datajsPatch=function(){}};
$C("$data.storageProviders.oData.oDataProvider",$data.StorageProviderBase,null,{constructor:function(a,b){this.SqlCommands=[];this.context=b;this.providerConfiguration=$data.typeSystem.extend({dbCreation:$data.storageProviders.DbCreationType.DropTableIfChanged,oDataServiceHost:"/odata.svc",serviceUrl:"",maxDataServiceVersion:"2.0",dataServiceVersion:void 0,setDataServiceVersionToMax:!0,user:null,password:null,withCredentials:!1,UpdateMethod:"PATCH"},a);"4.0"===this.providerConfiguration.maxDataServiceVersion?
"undefined"===typeof odatajs||"undefined"===typeof odatajs.oData?Guard.raise(new Exception("odatajs is required","Not Found!")):this.oData=odatajs.oData:"undefined"===typeof OData?Guard.raise(new Exception("datajs is required","Not Found!")):(this.oData=OData,datajsPatch(this.oData));this.fixkDataServiceVersions(a);this.context&&this.context._buildDbType_generateConvertToFunction&&this.buildDbType_generateConvertToFunction&&(this.context._buildDbType_generateConvertToFunction=this.buildDbType_generateConvertToFunction);
this.context&&this.context._buildDbType_modifyInstanceDefinition&&this.buildDbType_modifyInstanceDefinition&&(this.context._buildDbType_modifyInstanceDefinition=this.buildDbType_modifyInstanceDefinition)},fixkDataServiceVersions:function(a){this.providerConfiguration.dataServiceVersion>this.providerConfiguration.maxDataServiceVersion&&(this.providerConfiguration.dataServiceVersion=this.providerConfiguration.maxDataServiceVersion);!0===this.providerConfiguration.setDataServiceVersionToMax&&(this.providerConfiguration.dataServiceVersion=
this.providerConfiguration.maxDataServiceVersion);if(a&&!a.UpdateMethod&&"3.0">this.providerConfiguration.dataServiceVersion||!this.providerConfiguration.dataServiceVersion)this.providerConfiguration.UpdateMethod="MERGE"},initializeStore:function(a){a=$data.typeSystem.createCallbackSetting(a);switch(this.providerConfiguration.dbCreation){case $data.storageProviders.DbCreationType.DropAllExistingTables:var b=this;if(this.providerConfiguration.serviceUrl){var c=[{requestUri:b.providerConfiguration.serviceUrl+
"/Delete",method:"POST"},function(){a.success(b.context)},function(){a.success(b.context)}];this.appendBasicAuth(c[0],this.providerConfiguration.user,this.providerConfiguration.password,this.providerConfiguration.withCredentials);this.context.prepareRequest.call(this,c);this.oData.request.apply(this,c)}else a.success(b.context);break;default:a.success(this.context)}},buildDbType_generateConvertToFunction:function(a,b){return function(c,e){var d=new a.PhysicalType;d.entityState=c.entityState;a.PhysicalType.memberDefinitions.getPublicMappedProperties().forEach(function(a){d.initData[a.name]=
c[a.name]},this);a.Associations&&a.Associations.forEach(function(a){if("*"==a.FromMultiplicity&&"0..1"==a.ToMultiplicity||"0..1"==a.FromMultiplicity&&"1"==a.ToMultiplicity||"$$unbound"==a.FromMultiplicity){var g=c[a.FromPropertyName];if(void 0!==g)if(g instanceof $data.Array)d.initData[a.FromPropertyName]=d[a.FromPropertyName]||[],g.forEach(function(c){if(c.entityState==$data.EntityState.Modified||0>e.indexOf(c)){var g=b._storageModel.getStorageModel(c.getType()).TableName,c="("+b.storageProvider.getEntityKeysValue({data:c,
entitySet:b.getEntitySetFromElementType(c.getType())})+")";d.initData[a.FromPropertyName].push({__metadata:{uri:g+c}})}else g=e.indexOf(c),0>g&&Guard.raise("Dependency graph error"),d.initData[a.FromPropertyName].push({__metadata:{uri:"$"+(g+1)}})},this);else if(null===g)d.initData[a.FromPropertyName]=null;else if(g.entityState==$data.EntityState.Modified||0>e.indexOf(g)){var h=b._storageModel.getStorageModel(g.getType()).TableName,g="("+b.storageProvider.getEntityKeysValue({data:g,entitySet:b.getEntitySetFromElementType(g.getType())})+
")";d.initData[a.FromPropertyName]={__metadata:{uri:h+g}}}else h=e.indexOf(g),0>h&&Guard.raise("Dependency graph error"),d.initData[a.FromPropertyName]={__metadata:{uri:"$"+(h+1)}}}},this);a.ComplexTypes&&a.ComplexTypes.forEach(function(a){d.initData[a.FromPropertyName]=c[a.FromPropertyName]},this);return d}},buildDbType_modifyInstanceDefinition:function(){},executeQuery:function(a,b){var b=$data.typeSystem.createCallbackSetting(b),c={};try{c=this._compile(a)}catch(e){b.error(e);return}var d=this,
f="__count";"4.0"===this.providerConfiguration.maxDataServiceVersion&&(f="@odata.count");var g=[{requestUri:this.providerConfiguration.oDataServiceHost+c.queryText,method:c.method,data:c.postData,headers:{}},function(e,g,k){!e&&g.body&&!c.isBatchExecuteQuery&&(e=JSON.parse(g.body));if(b.success){var o=function(a,b,c){a.rawDataList="string"===typeof b?[{cnt:Container.convertTo(b,$data.Integer)}]:b;if(c.withInlineCount&&"object"===typeof b&&("undefined"!==typeof b[f]||"d"in b&&"undefined"!==typeof b.d[f]))a.__count=
(new Number("undefined"!==typeof b[f]?b[f]:b.d[f])).valueOf()};if(c.isBatchExecuteQuery){a.rawDataList=c.subQueries;for(var l=0;l<e.__batchResponses.length;l++){var j=e.__batchResponses[l];if(!j.data)if(j.body)j.data=JSON.parse(j.body);else{b.error(d.parseError(j,arguments));return}o(c.subQueries[l],j.data,c.subQueries[l]._getComplitedData())}}else o(a,e,c);b.success(a)}},function(a){b.error(d.parseError(a,arguments))},c.isBatchExecuteQuery?this.oData.batchHandler:void 0];this.providerConfiguration.maxDataServiceVersion&&
"4.0"!==this.providerConfiguration.maxDataServiceVersion&&(g[0].headers.MaxDataServiceVersion=this.providerConfiguration.maxDataServiceVersion);this.providerConfiguration.dataServiceVersion&&"4.0"!==this.providerConfiguration.maxDataServiceVersion&&(g[0].headers.DataServiceVersion=this.providerConfiguration.dataServiceVersion);"undefined"!==typeof this.providerConfiguration.enableJSONP&&(g[0].enableJsonpCallback=this.providerConfiguration.enableJSONP);"undefined"!==typeof this.providerConfiguration.useJsonLight&&
(g[0].useJsonLight=this.providerConfiguration.useJsonLight);this.appendBasicAuth(g[0],this.providerConfiguration.user,this.providerConfiguration.password,this.providerConfiguration.withCredentials);this.context.prepareRequest.call(this,g);this.oData.request.apply(this,g)},_compile:function(a){return(new $data.storageProviders.oData.oDataCompiler).compile(a)},saveChanges:function(a,b){0<b.length?this.saveInternal(this.buildIndependentBlocks(b),0,a):a.success(0)},saveInternal:function(a,b,c){(!0===
this.providerConfiguration.disableBatch||"object"===typeof $data.defaults&&!0===$data.defaults.disableBatch)&&"function"===typeof this._saveRestMany?this._saveRestMany(a,b,c):1<a.length||1==a.length&&1<a[0].length?this._saveBatch(a,b,c):this._saveRest(a,b,c)},_saveRest:function(a,b,c){for(var e=[],d,b=0;b<a.length;b++)for(var f=0;f<a[b].length;f++)switch(e.push(a[b][f].data),d={requestUri:this.providerConfiguration.oDataServiceHost+"/",headers:{}},this.providerConfiguration.maxDataServiceVersion&&
"4.0"!==this.providerConfiguration.maxDataServiceVersion&&(d.headers.MaxDataServiceVersion=this.providerConfiguration.maxDataServiceVersion),this.providerConfiguration.dataServiceVersion&&"4.0"!==this.providerConfiguration.maxDataServiceVersion&&(d.headers.DataServiceVersion=this.providerConfiguration.dataServiceVersion),"undefined"!==typeof this.providerConfiguration.useJsonLight&&(d.useJsonLight=this.providerConfiguration.useJsonLight),a[b][f].data.entityState){case $data.EntityState.Unchanged:continue;
case $data.EntityState.Added:d.method="POST";d.requestUri+=a[b][f].entitySet.tableName;d.data=this.save_getInitData(a[b][f],e);break;case $data.EntityState.Modified:d.method=this.providerConfiguration.UpdateMethod;d.requestUri+=a[b][f].entitySet.tableName;d.requestUri+="("+this.getEntityKeysValue(a[b][f])+")";this.save_addConcurrencyHeader(a[b][f],d.headers);d.data=this.save_getInitData(a[b][f],e);break;case $data.EntityState.Deleted:d.method="DELETE";d.requestUri+=a[b][f].entitySet.tableName;d.requestUri+=
"("+this.getEntityKeysValue(a[b][f])+")";this.save_addConcurrencyHeader(a[b][f],d.headers);break;default:Guard.raise(new Exception("Not supported Entity state"))}var g=this,a=[d,function(a,b){if(200<=b.statusCode&&300>b.statusCode){var d=e[0];if(204==b.statusCode){if(b.headers.ETag||b.headers.Etag||b.headers.etag){var f=d.getType().memberDefinitions.getPublicMappedProperties().filter(function(a){return a.concurrencyMode===$data.ConcurrencyMode.Fixed});f&&f[0]&&(d[f[0].name]=b.headers.ETag||b.headers.Etag||
b.headers.etag)}}else g.reload_fromResponse(d,a,b);c.success&&c.success(e.length)}else c.error(g.parseError(b))},function(a){c.error(g.parseError(a))}];this.appendBasicAuth(a[0],this.providerConfiguration.user,this.providerConfiguration.password,this.providerConfiguration.withCredentials);this.context.prepareRequest.call(this,a);this.oData.request.apply(this,a)},_saveBatch:function(a,b,c){for(var b=[],e=[],d=0;d<a.length;d++)for(var f=0;f<a[d].length;f++){e.push(a[d][f].data);var g={};g.headers={"Content-Id":e.length};
"4.0"!=this.providerConfiguration.maxDataServiceVersion&&(g.headers.MaxDataServiceVersion=this.providerConfiguration.maxDataServiceVersion);switch(a[d][f].data.entityState){case $data.EntityState.Unchanged:continue;case $data.EntityState.Added:g.method="POST";g.requestUri=a[d][f].entitySet.tableName;g.data=this.save_getInitData(a[d][f],e);break;case $data.EntityState.Modified:g.method=this.providerConfiguration.UpdateMethod;g.requestUri=a[d][f].entitySet.tableName;g.requestUri+="("+this.getEntityKeysValue(a[d][f])+
")";this.save_addConcurrencyHeader(a[d][f],g.headers);g.data=this.save_getInitData(a[d][f],e);break;case $data.EntityState.Deleted:g.method="DELETE";g.requestUri=a[d][f].entitySet.tableName;g.requestUri+="("+this.getEntityKeysValue(a[d][f])+")";this.save_addConcurrencyHeader(a[d][f],g.headers);break;default:Guard.raise(new Exception("Not supported Entity state"))}this.providerConfiguration.maxDataServiceVersion&&"4.0"!==this.providerConfiguration.maxDataServiceVersion&&(g.headers.MaxDataServiceVersion=
this.providerConfiguration.maxDataServiceVersion);this.providerConfiguration.dataServiceVersion&&"4.0"!==this.providerConfiguration.maxDataServiceVersion&&(g.headers.DataServiceVersion=this.providerConfiguration.dataServiceVersion);b.push(g)}var h=this,a=[{requestUri:this.providerConfiguration.oDataServiceHost+"/$batch",method:"POST",data:{__batchRequests:[{__changeRequests:b}]},headers:{}},function(a,b){if(202==b.statusCode){for(var d=a.__batchResponses[0].__changeResponses,g=[],f=0;f<d.length;f++)if(200<=
d[f].statusCode&&300>d[f].statusCode){var m=e[f];if(204==d[f].statusCode){if(d[f].headers.ETag||d[f].headers.Etag||d[f].headers.etag){var n=m.getType().memberDefinitions.getPublicMappedProperties().filter(function(a){return a.concurrencyMode===$data.ConcurrencyMode.Fixed});n&&n[0]&&(m[n[0].name]=d[f].headers.ETag||d[f].headers.Etag||d[f].headers.etag)}}else h.reload_fromResponse(m,d[f].data,d[f])}else g.push(h.parseError(d[f]));0<g.length?1===g.length?c.error(g[0]):c.error(new Exception("See inner exceptions",
"Batch failed",g)):c.success&&c.success(e.length)}else c.error(h.parseError(b))},function(a){c.error(h.parseError(a))},this.oData.batchHandler];this.providerConfiguration.maxDataServiceVersion&&"4.0"!=this.providerConfiguration.maxDataServiceVersion&&(a[0].headers.MaxDataServiceVersion=this.providerConfiguration.maxDataServiceVersion);this.providerConfiguration.dataServiceVersion&&"4.0"!=this.providerConfiguration.maxDataServiceVersion&&(a[0].headers.DataServiceVersion=this.providerConfiguration.dataServiceVersion);
"undefined"!==typeof this.providerConfiguration.useJsonLight&&(a[0].useJsonLight=this.providerConfiguration.useJsonLight);this.appendBasicAuth(a[0],this.providerConfiguration.user,this.providerConfiguration.password,this.providerConfiguration.withCredentials);this.context.prepareRequest.call(this,a);this.oData.request.apply(this,a)},reload_fromResponse:function(a,b,c){var e=this;a.getType().memberDefinitions.getPublicMappedProperties().forEach(function(d){var f=Container.resolveType(d.type);if(d.computed||
d.key||!d.inverseProperty)if(d.concurrencyMode===$data.ConcurrencyMode.Fixed)a[d.name]=c.headers.ETag||c.headers.Etag||c.headers.etag;else if(d.isAssignableTo)a[d.name]=b[d.name]?new f(b[d.name],{converters:e.fieldConverter.fromDb}):b[d.name];else if(f===$data.Array&&d.elementType)if(f=Container.resolveType(d.elementType),b[d.name]&&Array.isArray(b[d.name])){for(var g=[],h=0;h<b[d.name].length;h++){var i=b[d.name][h];if(f.isAssignableTo&&!Object.isNullOrUndefined(i))g.push(new f(i,{converters:e.fieldConverter.fromDb}));
else{var k=Container.resolveName(f),k=e.fieldConverter.fromDb[k];g.push(k?k(i):i)}}a[d.name]=g}else b[d.name]||(a[d.name]=b[d.name]);else f=Container.resolveName(d.type),f=e.fieldConverter.fromDb[f],a[d.name]=f?f(b[d.name]):b[d.name]},this)},save_getInitData:function(a,b,c,e){var d=this;a.physicalData=c?a.data:this.context._storageModel.getStorageModel(a.data.getType()).PhysicalType.convertTo(a.data,b);var f={};a.physicalData.getType().memberDefinitions.asArray().forEach(function(c){if(c.kind==$data.MemberTypes.complexProperty&&
a.physicalData[c.name])f[c.name]=d.save_getInitData({data:a.physicalData[c.name]},b,!0,!0);else if(c.kind==$data.MemberTypes.navProperty||c.kind==$data.MemberTypes.property&&!c.notMapped)if(e||"undefined"===typeof c.concurrencyMode&&(!0===c.key||a.data.entityState===$data.EntityState.Added||a.data.changedProperties&&a.data.changedProperties.some(function(a){return a.name===c.name})))if(c.kind==$data.MemberTypes.navProperty&&a.physicalData[c.name]&&"4.0"===this.providerConfiguration.maxDataServiceVersion)f[c.name+
"@odata.bind"]=a.physicalData[c.name].__metadata.uri;else{var h=Container.resolveName(c.type),h=d.fieldConverter.toDb[h];f[c.name]=h?h(a.physicalData[c.name]):a.physicalData[c.name]}},this);return f},save_addConcurrencyHeader:function(a,b){var c=a.data.getType().memberDefinitions.getPublicMappedProperties().filter(function(a){return a.concurrencyMode===$data.ConcurrencyMode.Fixed});c&&c[0]&&(b["If-Match"]=a.data[c[0].name])},getTraceString:function(a){this._compile(a);return a},supportedDataTypes:{value:[$data.Array,
$data.Integer,$data.String,$data.Number,$data.Blob,$data.Boolean,$data.Date,$data.Object,$data.GeographyPoint,$data.Guid,$data.GeographyLineString,$data.GeographyPolygon,$data.GeographyMultiPoint,$data.GeographyMultiLineString,$data.GeographyMultiPolygon,$data.GeographyCollection,$data.GeometryPoint,$data.GeometryLineString,$data.GeometryPolygon,$data.GeometryMultiPoint,$data.GeometryMultiLineString,$data.GeometryMultiPolygon,$data.GeometryCollection,$data.Byte,$data.SByte,$data.Decimal,$data.Float,
$data.Int16,$data.Int32,$data.Int64,$data.Time,$data.DateTimeOffset],writable:!1},supportedBinaryOperators:{value:{equal:{mapTo:"eq",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},notEqual:{mapTo:"ne",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},equalTyped:{mapTo:"eq",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},notEqualTyped:{mapTo:"ne",
dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},greaterThan:{mapTo:"gt",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},greaterThanOrEqual:{mapTo:"ge",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},lessThan:{mapTo:"lt",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},lessThenOrEqual:{mapTo:"le",
dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},or:{mapTo:"or",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},and:{mapTo:"and",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},add:{mapTo:"add",dataType:"number",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},divide:{mapTo:"div",allowedIn:[$data.Expressions.FilterExpression,
...
take:{},skip:{},orderBy:{},orderByDescending:{},first:{},include:{},batchDelete:{},withInlineCount:{},find:{}},enumerable:!0,writable:!0},supportedContextOperation:{value:{batchExecuteQuery:!0},enumerable:!0,writable:!0},fieldConverter:{value:$data.oDataConverter},resolveTypeOperations:function(a,b,c){var e=b.entityType.getMemberDefinition(a);(!e||!e.method||!1!==e.method.IsSideEffecting||!e.method.returnType||!(c===$data.Expressions.FilterExpression||c===$data.Expressions.OrderExpression))&&Guard.raise(new Exception("Entity '"+
...
$C("$data.storageProviders.oData.oDataCompiler",$data.Expressions.EntityExpressionVisitor,null,{constructor:function(){this.context={};this.provider={};this.mainEntitySet=this.includes=null},compile:function(a){this.provider=a.context.storageProvider;this.context=a.context;a.defaultType&&(this.mainEntitySet=a.context.getEntitySetFromElementType(a.defaultType));var b={urlText:""};this.Visit(a.expression,b);a.modelBinderConfig={};Container.createModelBinderConfigCompiler(a,this.includes,!0).Visit(a.expression);
var c=b.urlText,e=!1,d;for(d in b)"urlText"!=d&&"actionPack"!=d&&"data"!=d&&"lambda"!=d&&"method"!=d&&"postData"!=d&&"_isBatchExecuteQuery"!=d&&"_subQueries"!=d&&""!=b[d]&&(c=e?c+"&":c+"?",e=!0,c="$urlParams"!=d?c+(d+"="+b[d]):c+b[d]);a.queryText=c;a.postData=b.postData;var f={queryText:c,withInlineCount:"$inlinecount"in b||"$count"in b,method:b.method||"GET",postData:b.postData,isBatchExecuteQuery:b._isBatchExecuteQuery,subQueries:b._subQueries,params:[]};a._getComplitedData=function(){return f};
return f},VisitOrderExpression:function(a,b){this.Visit(a.source,b);Container.createoDataOrderCompiler(this.provider).compile(a,b)},VisitPagingExpression:function(a,b){this.Visit(a.source,b);Container.createoDataPagingCompiler(this.provider).compile(a,b)},VisitIncludeExpression:function(a,b){this.Visit(a.source,b);if(!b.$select){b.$expand=b.$expand?b.$expand+",":"";b.$expand+=a.selector.value.replace(/\./g,"/");this.includes=this.includes||[];for(var c=a.selector.value.split("."),e=null,d=this.mainEntitySet.entityContext._storageModel.getStorageModel(this.mainEntitySet.createNew),
f=0;f<c.length;f++)e=e?e+("."+c[f]):c[f],(d=d.Associations[c[f]])?this.includes.some(function(a){return a.name==e},this)||this.includes.push({name:e,type:d.ToType}):Guard.raise(new Exception("The given include path is invalid: "+a.selector.value+", invalid point: "+e)),d=this.mainEntitySet.entityContext._storageModel.getStorageModel(d.ToType)}},VisitFindExpression:function(a,b){this.Visit(a.source,b);b.urlText+="(";if(1===a.params.length){var c=a.params[0],e=Container.resolveName(c.type),d=this.provider.fieldConverter.toDb[e],
d=d?d(c.value):c.value,d=(d=this.provider.fieldConverter.escape[e])?d(c.value):c.value;b.urlText+=d}else for(var f=0;f<a.params.length;f++)c=a.params[f],e=Container.resolveName(c.type),(d=this.provider.fieldConverter.toDb[e])&&d(c.value),d=(d=this.provider.fieldConverter.escape[e])?d(c.value):c.value,0<f&&(b.urlText+=","),b.urlText+=c.name+"="+d;b.urlText+=")"},VisitProjectionExpression:function(a,b){this.Visit(a.source,b);Container.createoDataProjectionCompiler(this.context).compile(a,b)},VisitFilterExpression:function(a,
b){this.Visit(a.source,b);var c=Container.createoDataWhereCompiler(this.provider);b.data="";c.compile(a.selector,b);b.$filter=b.data;b.data=""},VisitInlineCountExpression:function(a,b){this.Visit(a.source,b);"4.0"===this.provider.providerConfiguration.maxDataServiceVersion?b.$count="allpages"===a.selector.value:b.$inlinecount=a.selector.value},VisitEntitySetExpression:function(a,b){b.urlText+="/"+a.instance.tableName;if(a.params)for(var c=0;c<a.params.length;c++)this.Visit(a.params[c],b)},VisitServiceOperationExpression:function(a,
b){a.boundItem&&(b.urlText+="/"+a.boundItem.entitySet.tableName,a.boundItem.data instanceof $data.Entity&&(b.urlText+="("+this.provider.getEntityKeysValue(a.boundItem)+")"));b.urlText+="/"+a.cfg.serviceName;b.method=b.method||a.cfg.method;if(a.params)for(var c=0;c<a.params.length;c++)this.Visit(a.params[c],b)},VisitBatchDeleteExpression:function(a,b){this.Visit(a.source,b);b.urlText+="/$batchDelete";b.method="DELETE"},VisitConstantExpression:function(a,b){var c=Container.resolveName(a.type);a.value instanceof
$data.Entity&&(c=$data.Entity.fullName);var e=this.provider.fieldConverter.toDb[c],d=e?e(a.value):a.value;"GET"===b.method||!b.method?(d=(e=this.provider.fieldConverter.escape[c])?e(d):d,void 0!==d&&(b.$urlParams=b.$urlParams?b.$urlParams+"&":"",b.$urlParams+=a.name+"="+d)):(b.postData=b.postData||{},b.postData[a.name]=d)},VisitCountExpression:function(a,b){this.Visit(a.source,b);b.urlText+="/$count"},VisitBatchExecuteQueryExpression:function(a,b){b.urlText+="/$batch";b.method="POST";b.postData={__batchRequests:[]};
b._isBatchExecuteQuery=!0;b._subQueries=a.members;for(var c=0;c<a.members.length;c++){var e=a.members[c],e=(new $data.storageProviders.oData.oDataCompiler).compile(e);b.postData.__batchRequests.push({requestUri:e.queryText,method:e.method,data:e.data,headers:e.headers})}}},{});
